...
public:
    ...
    virtual void            draw(const LLUIColor& color, const LLUIColor& highlight_color) const {};      // truncate to given width, if possible
...
public:
    ...
    /*virtual*/ void    draw(const LLUIColor& color, const LLUIColor& highlight_color) const;
