...
#ifndef BD_FLOATER_ANIMATOR_H
#define BD_FLOATER_ANIMATOR_H
...
class BDFloaterAnimator :
	public LLFloater
{
	friend class LLFloaterReg;
private:
	BDFloaterAnimator(const LLSD& key);
	/*virtual*/	~BDFloaterAnimator();
...
private:
	...
	LLSD 									mAnimJointMap; // 134 bones, 200 keyframes , 2 stats (rotation | time)
