...
//////////////////////////////////////////////////////////////////////////////
// mutator for current transparency value
void LLFloaterColorPicker::setCurT(F32 curTIn)
{
	// save current RGB
	curT = curTIn;

	// update corresponding HSL values and
	LLColor4(curR, curG, curB, curTIn).calcHSL(&curH, &curS, &curL);
...
//////////////////////////////////////////////////////////////////////////////
// accessor for current transparency value
void LLFloaterColorPicker::getCurT(F32& curTOut)
{
	curTOut = curT;
}
...
//	//BD - Color Picker Transparency
	...
	if (name == "tspin")
	{
		...
		// update component value with new value from text
		if (name == "tspin")
			tVal = (F32)ctrl->getValue().asReal() / 255.0f;
