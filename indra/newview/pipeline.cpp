...
bool addDeferredAttachments(LLRenderTarget& target, bool for_impostor = false)
{
	return target.addColorAttachment(for_impostor ? GL_RGBA : GL_SRGB8_ALPHA8) && //specular
			target.addColorAttachment(LLPipeline::RenderHighPrecisionNormals ? GL_RGBA12 : GL_RGB10_A2); //normal+z
}
...
void LLPipeline::bindDeferredShader(LLGLSLShader& shader, LLRenderTarget* light_target)
{
	...
	shader.uniform4f(LLShaderMgr::DEFERRED_SHADOW_RES, RenderShadowResolution.mV[VX], RenderShadowResolution.mV[VY], RenderShadowResolution.mV[VZ], RenderShadowResolution.mV[VW]);
	shader.uniform2f(LLShaderMgr::DEFERRED_PROJ_SHADOW_RES, RenderProjectorShadowResolution.mV[VX], RenderProjectorShadowResolution.mV[VY]);
...
/*void LLPipeline::generateWaterReflection(LLCamera& camera_in)
{
	...
	if (LLPipeline::sWaterReflections && LLDrawPoolWater::sNeedsReflectionUpdate)
	{
		...
		F32 pad = -camera_height * 0.05f; //amount to "pad" clip plane by
