...
public:
    ...
    //BD - UI Improvements
    bool handleScrollWheel(const LLVector2& texture_coords, S32 clicks_x, S32 clicks_y, MASK mask);
    bool handleScrollWheel(S32 x, S32 y, S32 clicks_x, S32 clicks_y, MASK mask);
