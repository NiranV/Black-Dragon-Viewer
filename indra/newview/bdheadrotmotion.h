...
#ifndef BD_BDHEADROTMOTION_H
#define BD_BDHEADROTMOTION_H
...
public:
	// Constructor
	BDHeadRotMotion(const LLUUID &id);

	// Destructor
	virtual ~BDHeadRotMotion();
...
public:
	...
	static LLMotion *create(const LLUUID &id) { return new BDHeadRotMotion(id); }
