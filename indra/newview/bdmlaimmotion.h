...
#ifndef BD_MLAIMMOTION_H
#define BD_MLAIMMOTION_H
...
public:
	// Constructor
	BDMLAimMotion(const LLUUID &id);

	// Destructor
	virtual ~BDMLAimMotion();
...
public:
	...
	static LLMotion *create(const LLUUID &id) { return new BDMLAimMotion(id); }
