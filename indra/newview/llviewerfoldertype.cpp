...
//	//BD - Custom Inventory Folder Icons
    ...
    addEntry(LLFolderType::FT_CLOTHING,             new ViewerFolderEntry("Clothing",               "Inv_SysOpen",          "Inv_ClothingClosed",   false,     true));
    addEntry(LLFolderType::FT_OBJECT,               new ViewerFolderEntry("Objects",                "Inv_SysOpen",          "Inv_ObjectsClosed",    false,     true));
    ...
    addEntry(LLFolderType::FT_BODYPART,             new ViewerFolderEntry("Body Parts",             "Inv_SysOpen",          "Inv_BodyPartsClosed",  false,     true));
