...
bool LLMaterialEditor::canModifyObjectsMaterial()
{
    ...
    return can_use_objects_material(func, std::vector<std::seed_seq::result_type>({PERM_MODIFY}), ItemSource::OBJECT, permissions, item_out);
}
...
bool LLMaterialEditor::canSaveObjectsMaterial()
{
    ...
    LLPermissions permissions;
    LLViewerInventoryItem* item_out;
    return can_use_objects_material(func, std::vector<std::seed_seq::result_type>({PERM_COPY, PERM_MODIFY}), ItemSource::AGENT, permissions, item_out);
}
...
bool LLMaterialEditor::canClipboardObjectsMaterial()
{
    ...
    LLPermissions permissions;
    LLViewerInventoryItem* item_out;
    return can_use_objects_material(func, std::vector<std::seed_seq::result_type>({PERM_COPY, PERM_MODIFY, PERM_TRANSFER}), ItemSource::OBJECT, permissions, item_out);
}
...
void LLMaterialEditor::saveObjectsMaterialAs()
{
    ...
    bool allowed = can_use_objects_material(func, std::vector<std::seed_seq::result_type>({PERM_COPY, PERM_MODIFY}), ItemSource::AGENT, permissions, item);
    if (!allowed)
    {
